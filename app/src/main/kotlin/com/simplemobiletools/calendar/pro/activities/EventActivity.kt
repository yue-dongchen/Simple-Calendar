...
class EventActivity : SimpleActivity() {
    ...
    private fun showAvailabilityPicker(currentValue: Int, callback: (Int) -> Unit) {
        val items = arrayListOf(
            RadioItem(Attendees.AVAILABILITY_BUSY, getString(R.string.busy)),
            RadioItem(Attendees.AVAILABILITY_FREE, getString(R.string.free))
        )
        RadioGroupDialog(this, items, currentValue) {
            callback(it as Int)
        }
    ...
    private fun updateAvailabilityText() {
        event_availability.text = if (mAvailability == Attendees.AVAILABILITY_FREE) getString(R.string.free) else getString(R.string.busy)
    }
